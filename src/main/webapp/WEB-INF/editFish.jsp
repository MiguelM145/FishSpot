...
<body>
	...
	<div id="container">
		<div id="addCatch">
			<form:form action="/fishs/edit/${fish.id}" method="POST" modelAttribute="fish">
				...
				<form:input type="hidden" path="fish" value="${fish.fish.id}"/>
		</div>		
				<input type="submit" id="button" value="Edit Your Catch">
			</form:form>
